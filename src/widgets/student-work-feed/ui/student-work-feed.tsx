...
export const StudentWorkFeed: FC<IStudentWorkFeedProps> = ({ studentWorks }) => (
  <div
    className="mt-20 w-fit grid grid-cols-12 grid-rows-1 justify-between gap-[60px]
      [&>*:nth-child(6n-5)]:col-span-6 [&>*:nth-child(6n-5)]:w-[485px]
      [&>*:nth-child(6n-4)]:col-span-6 [&>*:nth-child(6n-4)]:w-[485px]
      ...
      [&>*:nth-child(6n-3)]:col-span-12 [&>*:nth-child(6n-3)]:w-full"
  >
